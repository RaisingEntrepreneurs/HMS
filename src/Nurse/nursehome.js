...
const sections = [
  ...
  { title: 'Task', link: '/nursehome/nursetask', icon: 'assignment' },
  { title: 'Calendar', link: '/calendar', icon: 'calendar' },
  { title: 'Patients Management', link: '/patients', icon: 'people' },
  { title: 'Billing & Payments', link: '/billing', icon: 'payment' },
  { title: 'Reports', link: '/reports', icon: 'report' },
